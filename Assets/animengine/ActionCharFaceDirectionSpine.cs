...
namespace AC
{
	...
	[System.Serializable]
	public class ActionCharFaceDirectionSpine : Action
	{
		...
		public ActionCharFaceDirectionSpine ()
		{
			this.isDisplayed = true;
			category = ActionCategory.Character;
			title = "Face direction (Spine)";
			description = "Makes a Spine Character turn, either instantly or over time, to face a direction relative to the camera – i.e. up, down, left or right.";
		}
